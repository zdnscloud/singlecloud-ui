      ...
      <div className={classes.content}>
        <Breadcrumbs
          data={[
            ...
            {
              path: `/clusters/${clusterID}/namespaces/${namespaceID}/workloadGroup/${workloadID}`,
              name: <FormattedMessage {...messages.workloadDetailPageTitle} />,
            },
            {
              name: <FormattedMessage {...messages.podDetailPageTitle} />,
            },
          ]}
        />
        <GridContainer className={classes.grid}>
          <TableChart data={pods}/>
...
const mapStateToProps = createStructuredSelector({
  ...
  workloadID: makeSelectNamespaceID(),
  url: makeSelectURL(),
});
...
export default compose(withConnect)(PodDetailPage);
