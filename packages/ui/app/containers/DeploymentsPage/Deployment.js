              ...
              <GridContainer>
                      ...
                      {deployment.get('advancedOptions') ? (
                        <Fragment>
                          <GridContainer>
                            <GridItem xs={3} sm={3} md={3} className={classes.formLine}>
                              <ReadOnlyInput
                                labelText={<FormattedMessage {...messages.formReloadWhenConfigChange} />}
                                value={deployment.getIn(['advancedOptions', 'reloadWhenConfigChange'])}
                              />
                            </GridItem>
                          </GridContainer>
                          <GridContainer>
                            <GridItem xs={3} sm={3} md={3} className={classes.formLine}>
                              <ReadOnlyInput
                                ...
                                value={{
                                  ...
                                  nodeport: 'Node Port',
                                }[deployment.getIn(['advancedOptions', 'exposedServiceType'])]}
                              />
                            </GridItem>
                          </GridContainer>
                          <GridContainer>
                ...
                <GridItem xs={12} sm={12} md={12}>
                  <Card style={{ marginTop: 20, marginBottom: 0 }}>
                    ...
                    <CardBody>
                      {deployment.get('persistentVolumes') && deployment.get('persistentVolumes').map((pv) => (
                        <GridContainer>
                          <GridItem xs={3} sm={3} md={3} className={classes.formLine}>
                            <ReadOnlyInput
