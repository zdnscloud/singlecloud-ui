/*
 * CronJobsPage Messages
 *
 * This contains all the text for the CronJobsPage container.
 */

import { defineMessages } from 'react-intl';

export const scope = 'app.containers.CronJobsPage';

export default defineMessages({
  pageTitle: {
    id: `${scope}.pageTitle`,
    defaultMessage: 'CronJobsPage',
  },
  pageDesc: {
    id: `${scope}.pageDesc`,
  ...
  cronJobDetail: {
    id: `${scope}.cronJobDetail`,
    defaultMessage: 'CronJob Detail',
  },
  save: {
    id: `${scope}.save`,
    defaultMessage: 'Save',
