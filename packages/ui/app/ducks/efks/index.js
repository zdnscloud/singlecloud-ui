  ...
  switch (type) {
    ...
    case c.LOAD_EFKS_SUCCESS: {
      ...
      return state
        .update('errorsList', (errors) =>
          errors.filterNot((e) => e.type === c.LOAD_EFKS_FAILURE)
        )
    ...
    case c.CREATE_EFK_SUCCESS: {
      ...
      return state
        ...
        .update('errorsList', (errors) =>
          errors.filterNot((e) => e.type === c.CREATE_EFK_FAILURE)
        );
    }
    ...
    case c.READ_EFK_SUCCESS: {
      ...
      if (id) {
        return state
          ...
          .update('errorsList', (errors) =>
            errors.filterNot((e) => e.type === c.READ_EFK_FAILURE)
          );
      }
      return state;
    }
    ...
    case c.REMOVE_EFK_SUCCESS: {
      ...
      return state
        ...
        .update('errorsList', (errors) =>
          errors.filterNot((e) => e.type === c.REMOVE_EFK_FAILURE)
        );
    }
