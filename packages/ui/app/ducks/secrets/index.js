  ...
  switch (type) {
    ...
    case c.LOAD_SECRETS_SUCCESS: {
      ...
      return state
        .update('errorsList', (errors) =>
          errors.filterNot((e) => e.type === c.LOAD_SECRETS_FAILURE)
        )
    ...
    case c.CREATE_SECRET_SUCCESS: {
      ...
      return state
        ...
        .update('errorsList', (errors) =>
          errors.filterNot((e) => e.type === c.CREATE_SECRET_FAILURE)
        );
    }
    ...
    case c.UPDATE_SECRET_SUCCESS: {
      ...
      if (id) {
        return state
          ...
          .update('errorsList', (errors) =>
            errors.filterNot((e) => e.type === c.UPDATE_SECRET_FAILURE)
          );
      }
      return state;
    }
    ...
    case c.READ_SECRET_SUCCESS: {
      ...
      if (id) {
        return state
          .setIn(['data', clusterID, namespaceID, id], fromJS(data))
          .update('errorsList', (errors) =>
            errors.filterNot((e) => e.type === c.READ_SECRET_FAILURE)
          );
      }
      return state;
    }
    ...
    case c.REMOVE_SECRET_SUCCESS: {
      ...
      return state
        ...
        .update('errorsList', (errors) =>
          errors.filterNot((e) => e.type === c.REMOVE_SECRET_FAILURE)
        );
    }
