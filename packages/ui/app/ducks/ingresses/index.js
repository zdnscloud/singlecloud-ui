  ...
  switch (type) {
    ...
    case c.LOAD_INGRESSES_SUCCESS: {
      ...
      return state
        .update('errorsList', (errors) =>
          errors.filterNot((e) => e.type === c.LOAD_INGRESSES_FAILURE)
        )
    ...
    case c.CREATE_INGRESS_SUCCESS: {
      ...
      return state
        ...
        .update('errorsList', (errors) =>
          errors.filterNot((e) => e.type === c.CREATE_INGRESS_FAILURE)
        );
    }
    ...
    case c.READ_INGRESS_SUCCESS: {
      ...
      if (id) {
        return state
          .setIn(['data', clusterID, namespaceID, id], fromJS(data))
          .update('errorsList', (errors) =>
            errors.filterNot((e) => e.type === c.READ_INGRESS_FAILURE)
          );
      }
      return state;
    }
    ...
    case c.REMOVE_INGRESS_SUCCESS: {
      ...
      return state
        ...
        .update('errorsList', (errors) =>
          errors.filterNot((e) => e.type === c.REMOVE_INGRESS_FAILURE)
        );
    }
