 ...
 *
 */
export const prefix = 'cronJobs';

/**
 *  constants
 */
export const LOAD_CRON_JOBS = `${prefix}/LOAD_CRON_JOBS`;
export const LOAD_CRON_JOBS_SUCCESS = `${prefix}/LOAD_CRON_JOBS_SUCCESS`;
export const LOAD_CRON_JOBS_FAILURE = `${prefix}/LOAD_CRON_JOBS_FAILURE`;

export const CREATE_CRON_JOB = `${prefix}/CREATE_CRON_JOB`;
