  ...
  switch (type) {
    ...
    case c.LOAD_CRON_JOBS_SUCCESS: {
      ...
      return state
        .update('errorsList', (errors) =>
          errors.filterNot((e) => e.type === c.LOAD_CRON_JOBS_FAILURE)
        )
    ...
    case c.CREATE_CRON_JOB_SUCCESS: {
      ...
      return state
        ...
        .update('errorsList', (errors) =>
          errors.filterNot((e) => e.type === c.CREATE_CRON_JOB_FAILURE)
        );
    }
    ...
    case c.READ_CRON_JOB_SUCCESS: {
      ...
      if (id) {
        return state
          ...
          .update('errorsList', (errors) =>
            errors.filterNot((e) => e.type === c.READ_CRON_JOB_FAILURE)
          );
      }
      return state;
    }
    ...
    case c.REMOVE_CRON_JOB_SUCCESS: {
      ...
      return state
        ...
        .update('errorsList', (errors) =>
          errors.filterNot((e) => e.type === c.REMOVE_CRON_JOB_FAILURE)
        );
    }
