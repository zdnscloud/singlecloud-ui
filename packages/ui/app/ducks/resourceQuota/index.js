  ...
  switch (type) {
    ...
    case c.LOAD_RESOURCE_QUOTA_SUCCESS: {
      ...
      return state
        .update('errorsList', (errors) =>
          errors.filterNot((e) => e.type === c.LOAD_RESOURCE_QUOTA_FAILURE)
        )
    ...
    case c.CREATE_RESOURCE_QUOTUM_SUCCESS: {
      ...
      return state
        ...
        .update('errorsList', (errors) =>
          errors.filterNot((e) => e.type === c.CREATE_RESOURCE_QUOTUM_FAILURE)
        );
    }
    ...
    case c.READ_RESOURCE_QUOTUM_SUCCESS: {
      ...
      if (id) {
        return state
          ...
          .update('errorsList', (errors) =>
            errors.filterNot((e) => e.type === c.READ_RESOURCE_QUOTUM_FAILURE)
          );
      }
      return state;
    }
    ...
    case c.REMOVE_RESOURCE_QUOTUM_SUCCESS: {
      ...
      return state
        ...
        .update('errorsList', (errors) =>
          errors.filterNot((e) => e.type === c.REMOVE_RESOURCE_QUOTUM_FAILURE)
        );
    }
