  ...
  switch (type) {
    ...
    case c.LOAD_UDP_INGRESSES_SUCCESS: {
      ...
      return state
        .update('errorsList', (errors) =>
          errors.filterNot((e) => e.type === c.LOAD_UDP_INGRESSES_FAILURE)
        )
    ...
    case c.CREATE_UDP_INGRESS_SUCCESS: {
      ...
      return state
        ...
        .update('errorsList', (errors) =>
          errors.filterNot((e) => e.type === c.CREATE_UDP_INGRESS_FAILURE)
        );
    }
    ...
    case c.READ_UDP_INGRESS_SUCCESS: {
      ...
      if (id) {
        return state
          ...
          .update('errorsList', (errors) =>
            errors.filterNot((e) => e.type === c.READ_UDP_INGRESS_FAILURE)
          );
      }
      return state;
    }
    ...
    case c.REMOVE_UDP_INGRESS_SUCCESS: {
      ...
      return state
        ...
        .update('errorsList', (errors) =>
          errors.filterNot((e) => e.type === c.REMOVE_UDP_INGRESS_FAILURE)
        );
    }
