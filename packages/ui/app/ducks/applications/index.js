  ...
  switch (type) {
    ...
    case c.LOAD_APPLICATIONS_SUCCESS: {
      ...
      return state
        .update('errorsList', (errors) =>
          errors.filterNot((e) => e.type === c.LOAD_APPLICATIONS_FAILURE)
        )
    ...
    case c.CREATE_APPLICATION_SUCCESS: {
      ...
      return state
        ...
        .update('errorsList', (errors) =>
          errors.filterNot((e) => e.type === c.CREATE_APPLICATION_FAILURE)
        );
    }
    ...
    case c.READ_APPLICATION_SUCCESS: {
      ...
      if (id) {
        return state
          ...
          .update('errorsList', (errors) =>
            errors.filterNot((e) => e.type === c.READ_APPLICATION_FAILURE)
          );
      }
      return state;
    }
    ...
    case c.REMOVE_APPLICATION_SUCCESS: {
      ...
      return state
        ...
        .update('errorsList', (errors) =>
          errors.filterNot((e) => e.type === c.REMOVE_APPLICATION_FAILURE)
        );
    }
