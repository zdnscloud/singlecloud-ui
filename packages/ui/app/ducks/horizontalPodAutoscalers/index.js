  ...
  switch (type) {
    ...
    case c.LOAD_HORIZONTAL_POD_AUTOSCALERS_SUCCESS: {
      ...
      return state
        .update('errorsList', (errors) =>
          errors.filterNot(
            (e) => e.type === c.LOAD_HORIZONTAL_POD_AUTOSCALERS_FAILURE
          )
        )
    ...
    case c.CREATE_HORIZONTAL_POD_AUTOSCALER_SUCCESS: {
      ...
      return state
        ...
        .update('errorsList', (errors) =>
          errors.filterNot(
            (e) => e.type === c.CREATE_HORIZONTAL_POD_AUTOSCALER_FAILURE
          )
        );
    }
    ...
    case c.UPDATE_HORIZONTAL_POD_AUTOSCALER_SUCCESS: {
      ...
      if (id) {
        return state
          ...
          .update('errorsList', (errors) =>
            errors.filterNot(
              (e) => e.type === c.UPDATE_HORIZONTAL_POD_AUTOSCALER_FAILURE
            )
          );
      }
      return state;
    ...
    case c.READ_HORIZONTAL_POD_AUTOSCALER_SUCCESS: {
      ...
      if (id) {
        return state
          ...
          .update('errorsList', (errors) =>
            errors.filterNot(
              (e) => e.type === c.READ_HORIZONTAL_POD_AUTOSCALER_FAILURE
            )
          );
      }
      return state;
    ...
    case c.REMOVE_HORIZONTAL_POD_AUTOSCALER_SUCCESS: {
      ...
      return state
        ...
        .update('errorsList', (errors) =>
          errors.filterNot(
            (e) => e.type === c.REMOVE_HORIZONTAL_POD_AUTOSCALER_FAILURE
          )
        );
    }
