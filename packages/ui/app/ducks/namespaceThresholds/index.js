  ...
  switch (type) {
    ...
    case c.LOAD_NAMESPACE_THRESHOLDS_SUCCESS: {
      ...
      return state
        .update('errorsList', (errors) =>
          errors.filterNot(
            (e) => e.type === c.LOAD_NAMESPACE_THRESHOLDS_FAILURE
          )
        )
    ...
    case c.CREATE_NAMESPACE_THRESHOLD_SUCCESS: {
      ...
      return state
        ...
        .update('errorsList', (errors) =>
          errors.filterNot(
            (e) => e.type === c.CREATE_NAMESPACE_THRESHOLD_FAILURE
          )
        );
    }
    ...
    case c.UPDATE_NAMESPACE_THRESHOLD_SUCCESS: {
      ...
      if (id) {
        return state
          ...
          .update('errorsList', (errors) =>
            errors.filterNot(
              (e) => e.type === c.UPDATE_NAMESPACE_THRESHOLD_FAILURE
            )
          );
      }
      return state;
    ...
    case c.READ_NAMESPACE_THRESHOLD_SUCCESS: {
      ...
      if (id) {
        return state
          ...
          .update('errorsList', (errors) =>
            errors.filterNot(
              (e) => e.type === c.READ_NAMESPACE_THRESHOLD_FAILURE
            )
          );
      }
      return state;
    ...
    case c.REMOVE_NAMESPACE_THRESHOLD_SUCCESS: {
      ...
      return state
        ...
        .update('errorsList', (errors) =>
          errors.filterNot(
            (e) => e.type === c.REMOVE_NAMESPACE_THRESHOLD_FAILURE
          )
        );
    }
