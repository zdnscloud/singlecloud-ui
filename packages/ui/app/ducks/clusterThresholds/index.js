  ...
  switch (type) {
    ...
    case c.LOAD_CLUSTER_THRESHOLDS_SUCCESS: {
      ...
      return state
        .update('errorsList', (errors) =>
          errors.filterNot((e) => e.type === c.LOAD_CLUSTER_THRESHOLDS_FAILURE)
        )
    ...
    case c.CREATE_CLUSTER_THRESHOLD_SUCCESS: {
      ...
      return state
        ...
        .update('errorsList', (errors) =>
          errors.filterNot((e) => e.type === c.CREATE_CLUSTER_THRESHOLD_FAILURE)
        );
    }
    ...
    case c.UPDATE_CLUSTER_THRESHOLD_SUCCESS: {
      ...
      if (id) {
        return state
          ...
          .update('errorsList', (errors) =>
            errors.filterNot(
              (e) => e.type === c.UPDATE_CLUSTER_THRESHOLD_FAILURE
            )
          );
      }
      return state;
    ...
    case c.READ_CLUSTER_THRESHOLD_SUCCESS: {
      ...
      if (id) {
        return state
          .setIn(['data', clusterID, id], fromJS(data))
          .update('errorsList', (errors) =>
            errors.filterNot((e) => e.type === c.READ_CLUSTER_THRESHOLD_FAILURE)
          );
      }
      return state;
    }
    ...
    case c.REMOVE_CLUSTER_THRESHOLD_SUCCESS: {
      ...
      return state
        ...
        .update('errorsList', (errors) =>
          errors.filterNot((e) => e.type === c.REMOVE_CLUSTER_THRESHOLD_FAILURE)
        );
    }
