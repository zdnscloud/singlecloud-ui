  ...
  switch (type) {
    ...
    case c.LOAD_USER_QUOTA_SUCCESS: {
      ...
      return state
        .update('errorsList', (errors) =>
          errors.filterNot((e) => e.type === c.LOAD_USER_QUOTA_FAILURE)
        )
    ...
    case c.CREATE_USER_QUOTUM_SUCCESS: {
      ...
      return state
        ...
        .update('errorsList', (errors) =>
          errors.filterNot((e) => e.type === c.CREATE_USER_QUOTUM_FAILURE)
        );
    }
    ...
    case c.UPDATE_USER_QUOTUM_SUCCESS: {
      ...
      if (id) {
        return state
          ...
          .update('errorsList', (errors) =>
            errors.filterNot((e) => e.type === c.UPDATE_USER_QUOTUM_FAILURE)
          );
      }
      return state;
    }
    ...
    case c.READ_USER_QUOTUM_SUCCESS: {
      ...
      if (id) {
        return state
          .setIn(['data', id], fromJS(data))
          .update('errorsList', (errors) =>
            errors.filterNot((e) => e.type === c.READ_USER_QUOTUM_FAILURE)
          );
      }
      return state;
    }
    ...
    case c.REMOVE_USER_QUOTUM_SUCCESS: {
      ...
      return state
        ...
        .update('errorsList', (errors) =>
          errors.filterNot((e) => e.type === c.REMOVE_USER_QUOTUM_FAILURE)
        );
    }
